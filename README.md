...
This is Youbot and MoveIt! project, based on ROS and gazebo simulation. Robot is able to perform pick&place movements by using MoveIt!. There also a SLAM functionality impemented.
